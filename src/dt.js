        ...
        <div className="w-full flex px-2 py-1">
          ...
          <div className="w-1/4 flex ml-1">
            <div className="pr-4">
              {/* ** Logo ** */}
              <a href>
                <img className="w-12 p-0.5" src="/img/logo.png" alt="" srcSet />
              </a>
            </div>
          ...
          <div className="w-1/4 pl-8 flex">
            {/* header right */}
            <div className="w-5/12 flex py-0.875 px-2.5 mx-2 mt-1 mb-1.5 p-1.5 hover:bg-gray-200 round-avatar">
            ...
            <div className="w-7/12 pt-2 pb-2">
              <ul className="w-full flex">
                <li
                  className="w-10 bg-gray-200 text-center rounded-full cursor-pointer 
                            h-10 ml-1 mr-1"
                >
                  <div className="pt-1.5 relative">
                    <i className="fas fa-plus text-xm pt-1.5" />
                  </div>
                </li>
                <li
                  className="w-10 bg-gray-200 text-center rounded-full cursor-pointer 
                ...
                >
                  <div className="pt-1.5 relative">
                    <i className="fab fa-facebook-messenger text-xl" />
                    <span
